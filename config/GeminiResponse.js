...
Please provide the response in JSON format without no explanation, no additional words, just the result, ensure the JSON is formatted according to the following schema:
{
  "flights": [
    {
      "airline": "string",
